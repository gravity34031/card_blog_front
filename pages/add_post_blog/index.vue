    ...
    <div class='row'>
        <div class="container col-lg-5 col-12 mb-3">
            ...
            <Error :error='error' />
                ...
                <!-- ADD POST FORM -->
                <form @submit.stop.prevent='addPostBlog()'>
        ...
        <div class='col-lg-7 col-12 text-break'>
            ...
            <div class='container mt-2'>
                ...
                <div class='mb-5'>
                    ...
                    <small class="d-flex justify-content-end">Опубликовано: 01.01.2022, 00:00</small>
                </div>
                ...
                <div class="col-xxl-4 col-xl-6 col-lg-8 col-md-8 col-sm-10 col-12 card shadow-sm h-100 mx-auto">
                    ...
                    <div class="card-body d-flex flex-column justify-content-between">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <small class="text-muted ms-4 text-end">01.01.2022, 00:00</small>
                        </div>
...
export default {
    ...
    methods: {
        async addPostBlog(){
                let gallery = await this.addGallery()
                if (!gallery){
            ...
            try{
                const response = await this.$axios.post(`${process.env.baseUrl}/api/blog_posts/`, post)
                ...
                if(post.images){
                    try{
                        await this.$axios.delete(`${process.env.baseUrl}/api/gallery/${post.images}`)
                    } catch(errDel){
                        console.log(errDel)
                    } 
                }
        ...
        async addGallery(){
            ...
            let date = year + '-' + month + '-' + day + '_' + hour + '-' + min + '-' + sec + '_' + mil
            try{
                if (this.checkedPhotos.length == 0){
                    return false
                }
                const titleAndSlug = date
                let photos = this.checkedPhotos
                let photosSlug = []
                for (let photo of photos){
                    photosSlug.push(photo.slug)
                }
                const response = await this.$axios.post(`${process.env.baseUrl}/api/gallery/`, {
                    title: titleAndSlug,
                    slug: titleAndSlug,
                    photos: photosSlug
                })
